...
fn adorned_crocodile(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Adorned Crocodile".into(), mana_cost: ManaCost::parse("{4}{B}"),
        ...
        power: Some(Power::new(5)), toughness: Some(Toughness::new(3)), rarity: Rarity::Common,
        abilities: vec![
...
fn aegis_sculptor(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Aegis Sculptor".into(), mana_cost: ManaCost::parse("{3}{U}"),
        ...
        power: Some(Power::new(2)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::FLYING | KeywordAbilities::WARD,
...
fn alchemists_assistant(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Alchemist's Assistant".into(), mana_cost: ManaCost::parse("{1}{B}"),
        ...
        power: Some(Power::new(2)), toughness: Some(Toughness::new(1)), keywords: KeywordAbilities::LIFELINK,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::activated(id,
...
fn armament_dragon(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Armament Dragon".into(), mana_cost: ManaCost::parse("{3}{W}{B}{G}"),
        ...
        power: Some(Power::new(3)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::FLYING,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn dalkovan_packbeasts(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Dalkovan Packbeasts".into(), mana_cost: ManaCost::parse("{2}{W}"),
        ...
        power: Some(Power::new(0)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::VIGILANCE,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn flamehold_grappler(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Flamehold Grappler".into(), mana_cost: ManaCost::parse("{U}{R}{W}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Monk],
        power: Some(Power::new(3)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::FIRST_STRIKE,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn fleeting_effigy(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Fleeting Effigy".into(), mana_cost: ManaCost::parse("{R}"),
        ...
        power: Some(Power::new(2)), toughness: Some(Toughness::new(2)), keywords: KeywordAbilities::HASTE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::triggered(id,
...
fn gurmag_nightwatch(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Gurmag Nightwatch".into(), mana_cost: ManaCost::parse("{2/B}{2/G}{2/U}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Ranger],
        power: Some(Power::new(3)), toughness: Some(Toughness::new(3)), rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn gurmag_rakshasa(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Gurmag Rakshasa".into(), mana_cost: ManaCost::parse("{4}{B}{B}"),
        ...
        power: Some(Power::new(5)), toughness: Some(Toughness::new(5)), keywords: KeywordAbilities::MENACE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn highspire_bell_ringer(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Highspire Bell-Ringer".into(), mana_cost: ManaCost::parse("{2}{U}"),
        ...
        power: Some(Power::new(1)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::FLYING,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::static_ability(id,
                "The second spell you cast each turn costs {1} less to cast.",
                vec![StaticEffect::CostReduction { filter: Filter::new("spell", Predicate::All), amount: 1, condition: Some("second_spell_each_turn".into()) }]),
        ],
        ..Default::default() }
}
...
fn humbling_elder(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Humbling Elder".into(), mana_cost: ManaCost::parse("{U}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Monk],
        power: Some(Power::new(1)), toughness: Some(Toughness::new(2)), keywords: KeywordAbilities::FLASH,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                "When this creature enters, target creature an opponent controls gets -2/-0 until end of turn.",
                vec![Effect::BoostUntilEndOfTurn { power: Power::new(-2), toughness: Toughness::new(0) }],
...
fn jade_cast_sentinel(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Jade-Cast Sentinel".into(), mana_cost: ManaCost::parse("{4}"),
        ...
        power: Some(Power::new(1)), toughness: Some(Toughness::new(5)), keywords: KeywordAbilities::REACH,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::activated(id,
...
fn jeskai_brushmaster(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Jeskai Brushmaster".into(), mana_cost: ManaCost::parse("{1}{U}{R}{W}"),
        ...
        power: Some(Power::new(2)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::DOUBLE_STRIKE | KeywordAbilities::PROWESS,
...
fn kishla_skimmer(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Kishla Skimmer".into(), mana_cost: ManaCost::parse("{G}{U}"),
        ...
        power: Some(Power::new(2)), toughness: Some(Toughness::new(2)), keywords: KeywordAbilities::FLYING,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::triggered(id,
...
fn krotiq_nestguard(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Krotiq Nestguard".into(), mana_cost: ManaCost::parse("{2}{G}"),
        ...
        power: Some(Power::new(4)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::DEFENDER,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::activated(id,
...
fn marshal_of_the_lost(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Marshal of the Lost".into(), mana_cost: ManaCost::parse("{2}{W}{B}"),
        ...
        power: Some(Power::new(3)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::DEATHTOUCH,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::triggered(id,
...
fn nightblade_brigade(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Nightblade Brigade".into(), mana_cost: ManaCost::parse("{2}{B}"),
        ...
        power: Some(Power::new(1)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::DEATHTOUCH,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                "Mobilize 1 (When this creature enters, create a 1/1 white Soldier creature token.)",
...
fn rescue_leopard(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Rescue Leopard".into(), mana_cost: ManaCost::parse("{2}{R}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Cat],
        power: Some(Power::new(4)), toughness: Some(Toughness::new(2)), rarity: Rarity::Common,
        abilities: vec![
            Ability::triggered(id,
...
fn sagu_pummeler(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Sagu Pummeler".into(), mana_cost: ManaCost::parse("{3}{G}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Beast],
        power: Some(Power::new(4)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::REACH,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::activated(id,
...
fn sandskitter_outrider(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Sandskitter Outrider".into(), mana_cost: ManaCost::parse("{3}{B}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Goblin, SubType::Soldier],
        power: Some(Power::new(2)), toughness: Some(Toughness::new(1)), keywords: KeywordAbilities::MENACE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn shock_brigade(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Shock Brigade".into(), mana_cost: ManaCost::parse("{1}{R}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Goblin, SubType::Soldier],
        power: Some(Power::new(1)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::MENACE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                "Mobilize 1 (When this creature enters, create a 1/1 white Soldier creature token.)",
...
fn shocking_sharpshooter(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Shocking Sharpshooter".into(), mana_cost: ManaCost::parse("{1}{R}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Archer],
        power: Some(Power::new(1)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::REACH,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::triggered(id,
...
fn sinkhole_surveyor(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Sinkhole Surveyor".into(), mana_cost: ManaCost::parse("{1}{B}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Bird, SubType::Scout],
        power: Some(Power::new(1)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::FLYING,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::attacks_triggered(id,
...
fn skirmish_rhino(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Skirmish Rhino".into(), mana_cost: ManaCost::parse("{W}{B}{G}"),
        ...
        power: Some(Power::new(3)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::TRAMPLE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn summit_intimidator(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Summit Intimidator".into(), mana_cost: ManaCost::parse("{3}{R}"),
        ...
        power: Some(Power::new(4)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::REACH,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn undergrowth_leopard(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Undergrowth Leopard".into(), mana_cost: ManaCost::parse("{1}{G}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Cat],
        power: Some(Power::new(2)), toughness: Some(Toughness::new(2)), keywords: KeywordAbilities::VIGILANCE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::activated(id,
    ...
    CardData { id, owner, name: "Unsparing Boltcaster".into(), mana_cost: ManaCost::parse("{2}{R}"),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                ...
                TargetSpec::PermanentFiltered(Filter::new("creature an opponent controls", Predicate::creature().and(Predicate::Controller(TargetController::Opponent))))),
        ],
        ..Default::default() }
}
...
fn veteran_ice_climber(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Veteran Ice Climber".into(), mana_cost: ManaCost::parse("{1}{U}"),
        ...
        power: Some(Power::new(1)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::VIGILANCE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::static_ability(id,
    ...
    CardData { id, owner, name: "Dragonback Assault".into(), mana_cost: ManaCost::parse("{3}{G}{U}{R}"),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                ...
                vec![Effect::DealDamageAll { amount: 3, filter: Filter::new("creature or planeswalker", Predicate::creature().or(Predicate::planeswalker())) }],
                TargetSpec::None),
        ],
        ..Default::default() }
}
...
fn aggressive_negotiations(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Aggressive Negotiations".into(), mana_cost: ManaCost::parse("{1}{B}"),
        ...
        abilities: vec![Ability::spell(id,
            vec![Effect::Sacrifice { filter: Filter::any_creature() }],
            TargetSpec::None)],
        ..Default::default() }
}
...
fn kin_tree_severance(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Kin-Tree Severance".into(), mana_cost: ManaCost::parse("{2/W}{2/B}{2/G}"),
        ...
        abilities: vec![Ability::spell(id,
            vec![Effect::exile()],
            TargetSpec::PermanentFiltered(Filter::new("permanent with mana value 3 or greater", Predicate::ManaValueCompare(ComparisonType::GreaterOrEqual, 3))))],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Bone-Cairn Butcher".into(), mana_cost: ManaCost::parse("{3}{R}{W}{B}"),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                ...
                vec![Effect::Sacrifice { filter: Filter::creature_opponent_controls() }],
                TargetSpec::None),
        ],
        ..Default::default() }
}
...
fn devoted_duelist(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Devoted Duelist".into(), mana_cost: ManaCost::parse("{1}{R}"),
        ...
        power: Some(Power::new(2)), toughness: Some(Toughness::new(1)), keywords: KeywordAbilities::HASTE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::spell_cast_triggered(id,
...
fn meticulous_artisan(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Meticulous Artisan".into(), mana_cost: ManaCost::parse("{3}{R}"),
        ...
        power: Some(Power::new(3)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::PROWESS,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn salt_road_packbeast(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Salt Road Packbeast".into(), mana_cost: ManaCost::parse("{3}{W}{B}{G}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Beast],
        power: Some(Power::new(3)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::VIGILANCE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn unburied_earthcarver(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Unburied Earthcarver".into(), mana_cost: ManaCost::parse("{5}{B}"),
        ...
        power: Some(Power::new(5)), toughness: Some(Toughness::new(5)), rarity: Rarity::Common,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn zurgos_vanguard(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Zurgo's Vanguard".into(), mana_cost: ManaCost::parse("{R}{W}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Orc, SubType::Warrior],
        power: Some(Power::new(2)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::HASTE,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::dies_triggered(id,
    ...
    CardData { id, owner, name: "Dracogenesis".into(), mana_cost: ManaCost::parse("{6}{R}{R}"),
        ...
        abilities: vec![
            Ability::static_ability(id, "You may cast Dragon spells without paying their mana costs.",
                vec![StaticEffect::CostReduction { filter: Filter::new("Dragon spell", Predicate::HasSubType(SubType::Dragon)), amount: 99, condition: None }]),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Dragonstorm Globe".into(), mana_cost: ManaCost::parse("{3}"),
        ...
        abilities: vec![
            Ability::static_ability(id, "Each Dragon you control enters with an additional +1/+1 counter on it.",
                vec![StaticEffect::EntersWithAdditionalCounters { filter: Filter::new("Dragon you control", Predicate::creature().and(Predicate::HasSubType(SubType::Dragon)).and(Predicate::Controller(TargetController::You))), counter_type: "+1/+1".into(), count: 1 }]),
    ...
    CardData { id, owner, name: "Abzan Monument".into(), mana_cost: ManaCost::parse("{2}"),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                ...
                vec![Effect::search_library(Filter::new("basic Plains, Swamp, or Forest card", Predicate::HasSuperType(SuperType::Basic).and(Predicate::land()).and(Predicate::Or(vec![Predicate::HasSubType(SubType::Plains), Predicate::HasSubType(SubType::Swamp), Predicate::HasSubType(SubType::Forest)]))))],
                TargetSpec::None),
            Ability::activated(id,
    ...
    CardData { id, owner, name: "All-Out Assault".into(), mana_cost: ManaCost::parse("{2}{R}{W}{B}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::boost_controlled(Filter::creature_you_control(), 1, 1),
                     StaticEffect::grant_keyword_controlled(Filter::creature_you_control(), "deathtouch")]),
            Ability::enters_battlefield_triggered(id,
...
fn ambling_stormshell(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Ambling Stormshell".into(), mana_cost: ManaCost::parse("{3}{U}{U}"),
        ...
        power: Some(Power::new(5)), toughness: Some(Toughness::new(9)), keywords: KeywordAbilities::WARD, rarity: Rarity::Rare,
        abilities: vec![
            Ability::static_ability(id, "Ward {2}",
                vec![StaticEffect::ward("{2}")]),
            Ability::triggered(id,
    ...
    CardData { id, owner, name: "Barrensteppe Siege".into(), mana_cost: ManaCost::parse("{2}{W}{B}"),
        ...
        abilities: vec![
            ...
            Ability::triggered(id,
                ...
                vec![EventType::EndStep],
                vec![Effect::add_counters_all("+1/+1", 1, Filter::creature_you_control())],
                TargetSpec::None),
            Ability::triggered(id,
...
fn betor_kin_to_all(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Betor, Kin to All".into(), mana_cost: ManaCost::parse("{2}{W}{B}{G}"),
        ...
        supertypes: vec![SuperType::Legendary],
        power: Some(Power::new(5)), toughness: Some(Toughness::new(7)), keywords: KeywordAbilities::FLYING,
        rarity: Rarity::Mythic,
        abilities: vec![
            Ability::triggered(id,
    ...
    CardData { id, owner, name: "Call the Spirit Dragons".into(), mana_cost: ManaCost::parse("{W}{U}{B}{R}{G}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::grant_keyword_controlled(Filter::new("Dragon you control", Predicate::creature().and(Predicate::HasSubType(SubType::Dragon)).and(Predicate::Controller(TargetController::You))), "indestructible")]),
            Ability::triggered(id,
    ...
    CardData { id, owner, name: "Cori Steel-Cutter".into(), mana_cost: ManaCost::parse("{1}{R}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::boost_controlled(Filter::equipped_creature(), 2, 0),
                     StaticEffect::grant_keyword_controlled(Filter::equipped_creature(), "trample"),
                     StaticEffect::grant_keyword_controlled(Filter::equipped_creature(), "haste")]),
            Ability::spell_cast_triggered(id,
    ...
    CardData { id, owner, name: "Dragonfire Blade".into(), mana_cost: ManaCost::parse("{2}"),
        ...
        abilities: vec![
            Ability::static_ability(id, "Equipped creature gets +1/+0.",
                vec![StaticEffect::boost_controlled(Filter::equipped_creature(), 1, 0)]),
            Ability::triggered(id,
...
fn dragonologist(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Dragonologist".into(), mana_cost: ManaCost::parse("{U}"),
        ...
        power: Some(Power::new(1)), toughness: Some(Toughness::new(3)), rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn effortless_master(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Effortless Master".into(), mana_cost: ManaCost::parse("{3}{U}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Monk],
        power: Some(Power::new(3)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::FLASH,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::spell_cast_triggered(id,
...
fn embermouth_sentinel(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Embermouth Sentinel".into(), mana_cost: ManaCost::parse("{3}{R}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Warrior],
        power: Some(Power::new(4)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::HASTE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::triggered(id,
...
fn eshki_dragonclaw(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Eshki, Dragonclaw".into(), mana_cost: ManaCost::parse("{1}{R}{G}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Warrior],
        supertypes: vec![SuperType::Legendary],
        power: Some(Power::new(4)), toughness: Some(Toughness::new(4)), keywords: KeywordAbilities::TRAMPLE,
        rarity: Rarity::Rare,
        abilities: vec![
            Ability::triggered(id,
...
fn fangkeepers_familiar(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Fangkeeper's Familiar".into(), mana_cost: ManaCost::parse("{1}{G}"),
        ...
        power: Some(Power::new(2)), toughness: Some(Toughness::new(1)), keywords: KeywordAbilities::DEATHTOUCH,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::dies_triggered(id,
    ...
    CardData { id, owner, name: "Fire-Rim Form".into(), mana_cost: ManaCost::parse("{U}{R}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::boost_controlled(Filter::enchanted_creature(), 2, 2),
                     StaticEffect::grant_keyword_controlled(Filter::enchanted_creature(), "flying")]),
            Ability::triggered(id,
...
fn formation_breaker(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Formation Breaker".into(), mana_cost: ManaCost::parse("{2}{R}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Warrior],
        power: Some(Power::new(4)), toughness: Some(Toughness::new(3)), keywords: KeywordAbilities::HASTE,
        rarity: Rarity::Common,
        abilities: vec![
            Ability::triggered(id,
...
fn hollowmurk_siege(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Hollowmurk Siege".into(), mana_cost: ManaCost::parse("{2}{R}{G}"),
        ...
        abilities: vec![
            ...
            Ability::static_ability(id,
                "Temur — Creatures you control get +1/+0 and have trample.",
                vec![StaticEffect::boost_controlled(Filter::creature_you_control(), 1, 0),
                     StaticEffect::grant_keyword_controlled(Filter::creature_you_control(), "trample")]),
            Ability::triggered(id,
                "Mardu — Whenever a creature you control attacks alone, create a Treasure token.",
                vec![EventType::AttackerDeclared],
                vec![Effect::create_token("Treasure", 1)],
...
fn host_of_the_hereafter(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Host of the Hereafter".into(), mana_cost: ManaCost::parse("{3}{W}{B}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Spirit, SubType::Dragon],
        power: Some(Power::new(4)), toughness: Some(Toughness::new(5)), keywords: KeywordAbilities::FLYING,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::dies_triggered(id,
    ...
    CardData { id, owner, name: "Hundred-Battle Veteran".into(), mana_cost: ManaCost::parse("{1}{R}{W}"),
        ...
        abilities: vec![
            Ability::triggered(id,
                ...
                vec![EventType::AttackerDeclared],
                vec![Effect::add_p1p1_counters(1)],
                TargetSpec::PermanentFiltered(Filter::new("another attacking creature you control", Predicate::creature().and(Predicate::Controller(TargetController::You))).excludes_source().requires_attacking())),
        ],
        ..Default::default() }
}
...
fn karakyk_guardian(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Karakyk Guardian".into(), mana_cost: ManaCost::parse("{2}{W}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Spirit, SubType::Dragon],
        power: Some(Power::new(2)), toughness: Some(Toughness::new(5)),
...
fn dragonstorm_forecaster(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Dragonstorm Forecaster".into(), mana_cost: ManaCost::parse("{U}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Scout],
        power: Some(Power::new(0)), toughness: Some(Toughness::new(3)), rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::activated(id,
                ...
                vec![Effect::search_library(Filter::new("Dragonstorm Globe or Boulderborn Dragon", Predicate::Or(vec![Predicate::NameIs("Dragonstorm Globe".to_string()), Predicate::NameIs("Boulderborn Dragon".to_string())])))],
                TargetSpec::None),
        ],
        ..Default::default() }
}
...
fn hardened_tactician(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Hardened Tactician".into(), mana_cost: ManaCost::parse("{1}{W}{B}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Warrior],
        power: Some(Power::new(2)), toughness: Some(Toughness::new(4)), rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::activated(id,
    ...
    CardData { id, owner, name: "Osseous Exhale".into(), mana_cost: ManaCost::parse("{1}{W}"),
        ...
        abilities: vec![
            Ability::spell(id,
                ...
                TargetSpec::PermanentFiltered(Filter::attacking_or_blocking_creature())),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Snowmelt Stag".into(), mana_cost: ManaCost::parse("{3}{U}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::ConditionalSetBasePowerToughness { power: Power::new(5), toughness: Toughness::new(2), condition: "your_turn".into() }]),
            Ability::activated(id,
    ...
    CardData { id, owner, name: "Stormbeacon Blade".into(), mana_cost: ManaCost::parse("{1}{W}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::Boost { filter: Filter::equipped_creature(), power: Power::new(3), toughness: Toughness::new(0) }]),
            Ability::triggered(id,
...
fn sunset_strikemaster(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Sunset Strikemaster".into(), mana_cost: ManaCost::parse("{1}{R}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Human, SubType::Monk],
        power: Some(Power::new(3)), toughness: Some(Toughness::new(1)), rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::mana_ability(id, "{T}: Add {R}.", Mana::red(1)),
            Ability::activated(id,
                ...
                TargetSpec::PermanentFiltered(Filter::new("creature with flying", Predicate::creature().and(Predicate::HasKeyword(KeywordAbilities::FLYING))))),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Tempest Hawk".into(), mana_cost: ManaCost::parse("{2}{W}"),
        ...
        abilities: vec![
            Ability::triggered(id,
                ...
                vec![EventType::DamagedPlayer],
                vec![Effect::search_library(Filter::new("Tempest Hawk", Predicate::NameIs("Tempest Hawk".to_string())))],
                TargetSpec::None),
            Ability::static_ability(id,
...
fn trade_route_envoy(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Trade Route Envoy".into(), mana_cost: ManaCost::parse("{3}{G}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Dog, SubType::Soldier],
        power: Some(Power::new(4)), toughness: Some(Toughness::new(3)), rarity: Rarity::Rare,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
...
fn traveling_botanist(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Traveling Botanist".into(), mana_cost: ManaCost::parse("{1}{G}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Dog, SubType::Scout],
        power: Some(Power::new(2)), toughness: Some(Toughness::new(3)), rarity: Rarity::Rare,
        abilities: vec![
            Ability::triggered(id,
...
fn twinmaw_stormbrood(id: ObjectId, owner: PlayerId) -> CardData {
    ...
    CardData { id, owner, name: "Twinmaw Stormbrood".into(), mana_cost: ManaCost::parse("{5}{W}"),
        card_types: vec![CardType::Creature], subtypes: vec![SubType::Dragon],
        power: Some(Power::new(5)), toughness: Some(Toughness::new(4)),
        keywords: KeywordAbilities::FLYING,
        rarity: Rarity::Uncommon,
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
    ...
    CardData { id, owner, name: "Wingspan Stride".into(), mana_cost: ManaCost::parse("{U}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::Boost { filter: Filter::enchanted_creature(), power: Power::new(1), toughness: Toughness::new(1) },
    ...
    CardData { id, owner, name: "Magmatic Hellkite".into(),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                    ...
                    TargetSpec::PermanentFiltered(Filter::new("nonbasic land an opponent controls", Predicate::land().and(Predicate::Not(Box::new(Predicate::HasSuperType(SuperType::Basic)))).and(Predicate::Controller(TargetController::Opponent))))),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Mardu Monument".into(),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                    ...
                    vec![Effect::SearchLibrary { filter: Filter::new("basic Mountain, Plains, or Swamp card", Predicate::HasSuperType(SuperType::Basic).and(Predicate::land()).and(Predicate::Or(vec![Predicate::HasSubType(SubType::Mountain), Predicate::HasSubType(SubType::Plains), Predicate::HasSubType(SubType::Swamp)]))) }],
                    TargetSpec::None),
            Ability::activated(id,
    ...
    CardData { id, owner, name: "Mardu Siegebreaker".into(),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                    ...
                    vec![Effect::Destroy],
                    TargetSpec::PermanentFiltered(Filter::new("permanent an opponent controls with mana value 2 or less", Predicate::Controller(TargetController::Opponent).and(Predicate::ManaValueCompare(ComparisonType::LessOrEqual, 2))))),
            Ability::attacks_triggered(id,
    ...
    CardData { id, owner, name: "Naga Fleshcrafter".into(),
        ...
        abilities: vec![
            ...
            Ability::activated(id,
                ...
                TargetSpec::PermanentFiltered(Filter::new("nonlegendary creature you control", Predicate::creature().and(Predicate::Not(Box::new(Predicate::HasSuperType(SuperType::Legendary)))).and(Predicate::Controller(TargetController::You))))),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Neriv, Heart of the Storm".into(),
        ...
        abilities: vec![
            Ability::static_ability(id,
                    ...
                    vec![StaticEffect::Boost { filter: Filter::new("creature token you control", Predicate::creature().and(Predicate::IsToken).and(Predicate::Controller(TargetController::You))), power: Power::new(1), toughness: Toughness::new(1) },
                         StaticEffect::GrantKeyword { filter: Filter::new("creature token you control", Predicate::creature().and(Predicate::IsToken).and(Predicate::Controller(TargetController::You))), keyword: "haste".into() }]),
            Ability::attacks_triggered(id,
    ...
    CardData { id, owner, name: "Riling Dawnbreaker".into(),
        ...
        abilities: vec![
            Ability::triggered(id,
                    ...
                    vec![EventType::BeginCombat],
                    vec![Effect::BoostUntilEndOfTurn { power: Power::new(1), toughness: Toughness::new(0) }],
                    TargetSpec::PermanentFiltered(Filter::other_creature_you_control())),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Shiko, Paragon of the Way".into(),
        ...
        abilities: vec![
            ...
            Ability::static_ability(id,
                    ...
                    vec![StaticEffect::CostReduction { filter: Filter::new("noncreature spell", Predicate::NotCardType(CardType::Creature)), amount: 1, condition: None }]),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Starry-Eyed Skyrider".into(),
        ...
        abilities: vec![
            ...
            Ability::static_ability(id,
                    ...
                    vec![StaticEffect::GrantKeyword { filter: Filter::new("attacking token you control", Predicate::IsToken.and(Predicate::Controller(TargetController::You))).requires_attacking(), keyword: "flying".into() }]),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Static Snare".into(),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                    ...
                    vec![Effect::Exile],
                    TargetSpec::PermanentFiltered(Filter::new("artifact or creature an opponent controls", Predicate::Or(vec![Predicate::artifact(), Predicate::creature()]).and(Predicate::Controller(TargetController::Opponent))))),
            Ability::static_ability(id,
    ...
    CardData { id, owner, name: "Stormscale Scion".into(),
        ...
        abilities: vec![
            Ability::static_ability(id,
                    ...
                    vec![StaticEffect::Boost { filter: Filter::new("other Dragon you control", Predicate::creature().and(Predicate::HasSubType(SubType::Dragon)).and(Predicate::Controller(TargetController::You))).excludes_source(), power: Power::new(1), toughness: Toughness::new(1) }]),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Sunpearl Kirin".into(),
        ...
        abilities: vec![
            Ability::enters_battlefield_triggered(id,
                    ...
                    TargetSpec::PermanentFiltered(Filter::new("other nonland permanent you control", Predicate::nonland_permanent().and(Predicate::Controller(TargetController::You))).excludes_source())),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Temur Battlecrier".into(),
        ...
        abilities: vec![
            Ability::static_ability(id,
                    ...
                    vec![StaticEffect::GrantKeyword { filter: Filter::other_creature_you_control(), keyword: "trample".into() }]),
            Ability::attacks_triggered(id,
...
fn ureni_the_song_unending(id: ObjectId, owner: PlayerId) -> CardData {
    CardData { id, owner, name: "Ureni, the Song Unending".into(),
        ...
        subtypes: vec![SubType::Spirit, SubType::Dragon],
        supertypes: vec![SuperType::Legendary],
        power: Some(Power::new(10)), toughness: Some(Toughness::new(10)),
        rarity: Rarity::Mythic,
    ...
    CardData { id, owner, name: "War Effort".into(),
        ...
        abilities: vec![
            Ability::static_ability(id,
                    ...
                    vec![StaticEffect::Boost { filter: Filter::creature_you_control(), power: Power::new(1), toughness: Toughness::new(0) }]),
            Ability::triggered(id,
    ...
    CardData { id, owner, name: "Whirlwing Stormbrood".into(),
        ...
        abilities: vec![
            Ability::static_ability(id,
                    ...
                    vec![StaticEffect::GrantFlash { filter: Filter::new("sorcery or Dragon spell", Predicate::sorcery().or(Predicate::HasSubType(SubType::Dragon))) }]),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Zurgo, Thunder's Decree".into(),
        ...
        abilities: vec![
            Ability::attacks_triggered(id,
                    ...
                    vec![Effect::DealDamageAll { amount: 1, filter: Filter::new("creature defending player controls", Predicate::creature()) }],
                    TargetSpec::None),
            Ability::static_ability(id,
    ...
    CardData { id, owner, name: "Clarion Conqueror".into(), mana_cost: ManaCost::parse("{2}{W}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::CantActivateAbilities { filter: Filter::new("artifact, creature, or planeswalker", Predicate::Or(vec![Predicate::artifact(), Predicate::creature(), Predicate::planeswalker()])) }]),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Herd Heirloom".into(), mana_cost: ManaCost::parse("{1}{G}"),
        ...
        abilities: vec![
            Ability::activated(id,
                ...
                TargetSpec::PermanentFiltered(Filter::new("creature you control with power 4 or greater", Predicate::creature().and(Predicate::Controller(TargetController::You)).and(Predicate::PowerCompare(ComparisonType::GreaterOrEqual, 4))))),
    ...
    CardData { id, owner, name: "Jeskai Monument".into(), mana_cost: ManaCost::parse("{2}"),
        ...
        abilities: vec![
            Ability::triggered(id,
                ...
                vec![EventType::EnteredTheBattlefield],
                vec![Effect::SearchLibrary { filter: Filter::new("basic Island, Mountain, or Plains card", Predicate::HasSuperType(SuperType::Basic).and(Predicate::land()).and(Predicate::Or(vec![Predicate::HasSubType(SubType::Island), Predicate::HasSubType(SubType::Mountain), Predicate::HasSubType(SubType::Plains)]))) }],
                TargetSpec::None),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Marang River Regent".into(),
        ...
        abilities: vec![
            Ability::triggered(id,
                ...
                vec![EventType::EnteredTheBattlefield],
                vec![Effect::Bounce],
                TargetSpec::Multiple { spec: Box::new(TargetSpec::PermanentFiltered(Filter::other_nonland_permanent())), count: 2 }),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Sultai Monument".into(), mana_cost: ManaCost::parse("{2}"),
        ...
        abilities: vec![
            Ability::triggered(id,
                ...
                vec![EventType::EnteredTheBattlefield],
                vec![Effect::SearchLibrary { filter: Filter::new("basic Swamp, Forest, or Island card", Predicate::HasSuperType(SuperType::Basic).and(Predicate::land()).and(Predicate::Or(vec![Predicate::HasSubType(SubType::Swamp), Predicate::HasSubType(SubType::Forest), Predicate::HasSubType(SubType::Island)]))) }],
                TargetSpec::None),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Temur Monument".into(), mana_cost: ManaCost::parse("{2}"),
        ...
        abilities: vec![
            Ability::triggered(id,
                ...
                vec![EventType::EnteredTheBattlefield],
                vec![Effect::SearchLibrary { filter: Filter::new("basic Forest, Island, or Mountain card", Predicate::HasSuperType(SuperType::Basic).and(Predicate::land()).and(Predicate::Or(vec![Predicate::HasSubType(SubType::Forest), Predicate::HasSubType(SubType::Island), Predicate::HasSubType(SubType::Mountain)]))) }],
                TargetSpec::None),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "The Sibsig Ceremony".into(), mana_cost: ManaCost::parse("{B}{B}{B}"),
        ...
        abilities: vec![
            Ability::static_ability(id,
                ...
                vec![StaticEffect::CostReduction { filter: Filter::new("creature spell", Predicate::creature()), amount: 2, condition: None }]),
        ],
        ..Default::default() }
}
    ...
    CardData { id, owner, name: "Underfoot Underdogs".into(), mana_cost: ManaCost::parse("{2}{R}"),
        ...
        abilities: vec![
            ...
            Ability::activated(id,
                ...
                vec![Effect::CantBlock],
                TargetSpec::PermanentFiltered(Filter::new("creature you control with power 2 or less", Predicate::creature().and(Predicate::Controller(TargetController::You)).and(Predicate::PowerCompare(ComparisonType::LessOrEqual, 2))))),
        ],
        ..Default::default() }
}
